  ...
  <div class="common-layout">
    <el-container>
      ...
      <el-container>
        ...
        <el-aside width="200px" class="aside">
          <el-menu router>
            ...
            <el-sub-menu index="/message">
              ...
              <el-menu-item index="/act"><el-icon>
                  <Notification />
                </el-icon>活动管理</el-menu-item>
            </el-sub-menu>

            <el-menu-item index="/actType">
              <el-icon>
                <Promotion />
              </el-icon> 活动类型管理
            </el-menu-item>
            ...
            <el-sub-menu index="/report">
              ...
              <el-menu-item index="/userReport"><el-icon>
                  <Share />
                </el-icon>用户性别统计</el-menu-item>
              <el-menu-item index="/actReport"><el-icon>
                  <InfoFilled />
                </el-icon>活动类型统计</el-menu-item>
            </el-sub-menu>
        ...
        <!-- 中间核心展示区域 -->
        <el-main class="main-content" :class="{ 'no-padding': route.name === 'index' }">
